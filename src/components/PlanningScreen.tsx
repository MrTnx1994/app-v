                              ...
                              <div className="space-y-1 bg-white/60 p-1 rounded-md border border-slate-150 shadow-sm">
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className={`w-full font-black focus:outline-none text-center pl-1 pr-9 text-xs rounded py-1 focus:bg-white focus:border-blue-400 focus:ring-1 focus:ring-blue-400/30 border ${getDriverColorClass(inv.driverName, inv.round, drivers)}`}
                                    placeholder="باربری..."
                                  />
                                </div>
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className={`w-full font-bold focus:outline-none text-center pl-1 pr-11 text-[9px] rounded py-1 focus:bg-white focus:border-blue-400 focus:ring-1 focus:ring-blue-400/30 border ${getDriverColorClass(inv.driverName, inv.round, drivers)}`}
                                    placeholder="توضیحات..."
                                  />
                                </div>
                              </div>
                      ...
                      {driverSearchSlots.map((slot, idx) => {
                        ...
                        if (driver) {
                          invoices
                            ...
                            .forEach((inv) => {
                              totalCartons += getInvoiceCartonsVolumetric(inv, products);
                            });
                        }
